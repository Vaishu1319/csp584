        ...
        {           
			...
			{	
                if(!hm.containsKey(PName)){
					pw.println("<h2 style='color:#333333'>There are no reviews for this product.</h2>");
				}	
				else
				{
					int count = 0;
					for (Review r : hm.get(PName)) 
				 	{	
				 		...
				 		String space = "";
				 		if(count == 0){
							pw.print("<p style='color:#333333; padding-top:20px; font-size:16px; margin-bottom:3px; line-height:0.5em;'><strong>Product Name:</strong>"+"&nbsp&nbsp&nbsp&nbsp&nbsp<strong>"+r.getPName()+"</strong></p>");
							pw.print("<p style='color:#333333; padding-top:20px; font-size:16px; margin-bottom:3px; line-height:0.5em;'><strong>Product Category:</strong>"+"&nbsp&nbsp&nbsp&nbsp&nbsp<strong>"+r.getPType()+"</strong></p>");
							count++;
						}
