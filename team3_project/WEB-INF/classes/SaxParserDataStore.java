   ...
   //parse the xml using sax parser to get the data
    ...
    public void endElement(String str1, String str2, String element) throws SAXException {
		...
		if (element.equalsIgnoreCase("address")) {
            if(currentElement.equals("doctor")){
				doctor.setAddress(elementValueRead);
				address = elementValueRead;
			}
			if(currentElement.equals("hospital")){
				hospital.setAddress(elementValueRead);
				address = elementValueRead;
			}
			return;
		}
		...
		if (element.equalsIgnoreCase("fees")) {
			...
			MySqlDataStoreUtilities.insertDoctor(Id,name,address,speciality,image,experience,fees,type);
			return;
		}
	}
