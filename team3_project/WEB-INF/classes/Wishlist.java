           ...
           response.setContentType("text/html");
			...
			if(wishlists.size() != 0) {
				...
				for(Map.Entry<String, String[]> entry : wishlists.entrySet())
				{
					...
					pw.print("<td style='font-size:14px;text-align:left;color:#006666;width:50%;border:none !important;padding-right:70px !important;'>"
					+ "<a href='Detail?ID=" + wishlist[2] + "'><b>"  + wishlist[1] + "</b></a>"					
					+ "<br>" + wishlist[3] + "<br>" + wishlist[4] + "<br></td><br>");	
