...
public class Login extends HttpServlet {
	...
	protected void displayLogin(HttpServletRequest request,
		...
		pw.print("<h2 class='title meta'><a style='font-size: 36px;color:#006666 !important;'>LOGIN<br><br></a></h2>"
				+ "<div class='entry'>"
				+ "<div class='post1'>");
		if (error)
			...
			if(session.getAttribute("login_msg")!=null){
				if(session.getAttribute("msg_src").equals("Registration")) {
					pw.print("<h4 style='color:darkgreen'>"+session.getAttribute("login_msg")+"</h4>");
		...
		pw.print("<form method='post' action='Login'>"
				...
				+ "<h3 style='color:#006666 !important;'>Username</h3></td><td><input type='text' name='username' value='' class='input' required></input>"
				+ "</td></tr><tr><td>"
