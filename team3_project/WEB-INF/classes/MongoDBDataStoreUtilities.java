...
public class MongoDBDataStoreUtilities
{
	...
	public static String insertReview(String username,String PName,String PType,String RName,String  Rzip,String RCity,String RState,String UAge,String UGender,String UOccupation,String RRating,String RDate,String RText)
	{
		try
		{		
			getConnection();
		...
		try
		{
			...
			while (cursor.hasNext())
			{
			   ...
			   if(!reviews.containsKey(obj.getString("ProviderName")))
				...
				Review review =new Review(obj.getString("CustomerId"),obj.getString("ProviderName"),obj.getString("ProviderType"),
					obj.getString("CustomerName"),obj.getString("CustomerZIP"),obj.getString("CustomerCity"),obj.getString("CustomerState"),obj.getString("CustomerAge"),obj.getString("CustomerGender"),obj.getString("CustomerOccupation"),obj.getString("ReviewRating"),
	...
	public static ArrayList <Mostsold> mostsoldProviders()
	{
