...
public class PharmacyList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<a style='font-size: 32px;color: #8f0419 !important;'>Pharmacy Lists</a>");
		...
		for(Map.Entry<String, Pharmacy> entry : hm.entrySet()){
			...
			if (type.equalsIgnoreCase("Pharmacy")) {
				...
				+ pharmacy.getStAddress() + ", " + pharmacy.getCity() + ", " + pharmacy.getState() + ", " + pharmacy.getZipCode() + "<br>"
				+ pharmacy.getFees() + "$ Consulatation Fee");
